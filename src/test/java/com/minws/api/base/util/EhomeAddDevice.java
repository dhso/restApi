...
public class EhomeAddDevice {
	...
	public static void main(String[] args) throws JsonProcessingException, IOException {
		...
		String uri = "http://127.0.0.1:8080/api/api/ehome/device/add?signature="+signatureStr+"&timestamp="+timestamp+"&appid="+appid;
		Device device = new Device();
		device.setName("树莓派CPU");
		device.setType("樹莓派");
		device.setUnit("℃");
